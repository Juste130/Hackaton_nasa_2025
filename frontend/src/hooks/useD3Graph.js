...
export const useD3Graph = (containerRef, data, options = {}) => {
  ...
  useEffect(() => {
    ...
    const node = g.append('g')
      ...
      .on('mouseover', (event, d) => onNodeHover(d, event, true))
      .on('mouseout', (event, d) => onNodeHover(d, event, false));
  ...
  }, [data, dimensions, onNodeClick, onNodeHover, enableZoom, enableDrag, forceStrength, linkDistance]);
