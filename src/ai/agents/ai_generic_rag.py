...
from src.services.search_engine import HybridSearchEngine, SearchMode
from src.database.client import DatabaseClient, Publication
...
# DSPy Signature to extract citations
