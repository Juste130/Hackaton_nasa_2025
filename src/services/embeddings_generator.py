...
class EmbeddingsGenerator:
    ...
    def generate_embedding(self, text: str) -> List[float]:
        ...
        if not text or len(text.strip()) < 10:
            ...
            return [0.0] * (self.embedding_dim or 384)  # fallback to 384 dims if None
    ...
    async def semantic_search_publications(
        ...
        async with self.db_client.async_session() as session:
            ...
            result = await session.execute(
                ...
                """),
                {
                    "query_embedding": embedding_json,  # ← Use JSON instead of str()
    ...
    async def find_similar_publications(
        ...
        async with self.db_client.async_session() as session:
            ...
            params = {
                "source_embedding": embedding_json,  # ← Use JSON instead of str()
                "top_k": top_k
            }
